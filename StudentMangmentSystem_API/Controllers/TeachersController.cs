    ...
    public class TeachersController : ControllerBase
    {
        ...
        public async Task<ActionResult<ResponseApi<TeacherReadDto>>> Create(TeacherCreateDto dto)
        {
            if (!ModelState.IsValid)
                return BadRequest(ResponseApi<TeacherReadDto>.BadRequst("Please Enter Valid Data"));
        ...
        public async Task<ActionResult<ResponseApi<object>>> Delete(int id)
        {
            ...
            return Ok(ResponseApi<object>.NoContant(null, "Teacher Deleted Successfully."));
        }
    }
}