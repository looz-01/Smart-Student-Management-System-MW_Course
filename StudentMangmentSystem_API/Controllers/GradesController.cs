    ...
    public class GradesController : ControllerBase
    {
        ...
        public async Task<ActionResult<ResponseApi<GradeReadDto>>> Create(GradeCreateDto dto)
        {
            if (!ModelState.IsValid)
                return BadRequest(ResponseApi<GradeReadDto>.BadRequst("Please Enter Valid Data"));
            ...
            {
                return BadRequest(ResponseApi<GradeReadDto>.BadRequst(ex.Message));
            }
        }
        ...
        public async Task<ActionResult<ResponseApi<object>>> Delete(int id)
        {
            ...
            return Ok(ResponseApi<object>.NoContant(null, "Grade Deleted Successfully."));
        }
    }
}