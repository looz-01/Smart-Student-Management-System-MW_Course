    ...
    public class EnrollmentsController : ControllerBase
    {
        ...
        public async Task<ActionResult<ResponseApi<EnrollmentReadDto>>> Create(EnrollmentCreateDto dto)
        {
            if (!ModelState.IsValid)
                return BadRequest(ResponseApi<EnrollmentReadDto>.BadRequst("Please Enter Valid Data"));
            ...
            {
                return BadRequest(ResponseApi<EnrollmentReadDto>.BadRequst(ex.Message));
            }
        }
        ...
        public async Task<ActionResult<ResponseApi<object>>> Delete(int studentId, int courseId)
        {
            ...
            return Ok(ResponseApi<object>.NoContant(null, "Enrollment Deleted Successfully."));
        }
    }
}